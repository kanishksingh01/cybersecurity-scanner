    ...
    <div className="min-h-screen bg-gray-950 flex flex-col">
      <main className="flex-1 px-4 py-12 max-w-6xl mx-auto w-full">
        <div className="text-center mb-10">
          ...
          <a
            href="https://github.com/kanishksingh01/cybersecurity-scanner"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 mt-4 px-4 py-2 text-sm font-medium text-gray-300 bg-gray-800 border border-gray-700 rounded-lg hover:bg-gray-700 hover:text-white transition-colors"
          >
